...
namespace Common.HttpClients
{
    ...
    public interface IHttpHelper
    {
        ...
        /// <returns></returns>
        Task<Stream> GetStreamAsync(string url, string bearerToken = "", IDictionary<string, string> headers = null, CancellationToken cancellation = default);
        ...
        /// <param name="cancellation"></param>
        /// <returns></returns>
        Task<string> GetAsync(string url, string bearerToken = "", IDictionary<string, string> headers = null, CancellationToken cancellation = default);
        ...
        /// <param name="cancellation"></param>
        /// <returns></returns>
        Task<T> GetAsync<T>(string url, string bearerToken = "", IDictionary<string, string> headers = null, CancellationToken cancellation = default);
        ...
        /// <param name="cancellation"></param>
        /// <returns></returns>
        Task<T> PostAsync<T>(string url, object data, string bearerToken = "", IDictionary<string, string> headers = null, CancellationToken cancellation = default);
        ...
        /// <param name="cancellation"></param>
        /// <returns></returns>
        Task<T> PutAsync<T>(string url, object data, string bearerToken = "", IDictionary<string, string> headers = null, CancellationToken cancellation = default);
        ...
        /// <param name="cancellation"></param>
        /// <returns></returns>
        Task<string> DeleteAsync(string url, string bearerToken = "", IDictionary<string, string> headers = null, CancellationToken cancellation = default);
        ...
        /// <param name="cancellation"></param>
        /// <returns></returns>
        Task<T> DeleteAsync<T>(string url, string bearerToken = "", IDictionary<string, string> headers = null, CancellationToken cancellation = default);
