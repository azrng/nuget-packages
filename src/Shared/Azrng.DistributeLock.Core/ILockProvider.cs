namespace Azrng.DistributeLock.Core
{
    ...
    public interface ILockProvider
    {
        ...
        /// 长耗时任务建议监听 <see cref="LockInstance.LockLostToken"/>，在续期失败导致锁丢失时及时中止业务
        /// </remarks>
        Task<LockInstance?> LockAsync(string lockKey, TimeSpan? expire = null, TimeSpan? getLockTimeOut = null,
