...
//        public static string connectionString = ConfigurationManager.ConnectionStrings["OraConnectionString"].ConnectionString;
//        public OracleHelper()
//        {
//        }
...
//        {
//            //string SQLString = "Select To_Char(SYSDATE，'yyyyMMddHHmmss') from dual";
//            string datetime = "";
...
//                        if (dataReader.Read())
//                        {
//                            datetime = dataReader[0].ToString();
//                        }
//                        dataReader.Close();
//                    }
...
//                {
//                    new LogHelper().WriteErrorLog(string.Format("Oracle事务异常,{0}", ex.Message));
//                    tx.Rollback();
//                    return false;
//                    //throw new Exception(E.Message);
//                }
...
//        public static bool ExecuteSqlTran(System.Collections.Generic.List<Hashtable> SQLStringList)
//        {
//            using (OracleConnection conn = new OracleConnection(connectionString))
//            {
//                conn.Open();
...
//                    {
//                        //循环
//                        foreach (Hashtable item in SQLStringList)
//                        {
//                            foreach (DictionaryEntry myDE in item)
//                            {
...
//                    {
//                        conn.Close();
//                        conn.Dispose();//打开后需要关闭释放
//                    }
//                }
//            }
//        }

//        public static bool Manange(System.Collections.Hashtable hash)
//        {
//            bool b = false;
//            foreach (System.Collections.DictionaryEntry entry in hash)
//            {
//                OracleParameter[] parameters = (OracleParameter[])entry.Value;
//                int rows = ExecuteSql(entry.Key.ToString(), parameters);
//                if (rows > 0)
//                {
//                    b = true;
//                }
