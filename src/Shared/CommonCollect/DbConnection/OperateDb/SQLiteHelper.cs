...
//        /// <param name="colNames">字段名</param>
//        /// <param name="colValues">字段名对应的数据</param>
//        public SQLiteDataReader DeleteValuesOR(string tableName, string[] colNames, string[] colValues,
//            string[] operations)
//        {
//            //当字段名称和字段数值不对应时引发异常
...
//        /// <param name="colNames">字段名</param>
//        /// <param name="colValues">字段名对应的数据</param>
//        public SQLiteDataReader DeleteValuesAND(string tableName, string[] colNames, string[] colValues,
//            string[] operations)
//        {
//            //当字段名称和字段数值不对应时引发异常
//            if (colNames.Length != colValues.Length || operations.Length != colNames.Length ||
