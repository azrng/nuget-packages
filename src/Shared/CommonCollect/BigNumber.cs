...
#pragma warning restore CA2211
    ...
    {
        var num = new BigNumber { whole = whole - 1, numerator = 1, denominator = 1, Sign = whole.Sign };
        num.Simplify();
        return num;
    }
    ...
    {
        var num = new BigNumber { whole = 0, numerator = numerator, denominator = denominator, Sign = numerator.Sign };
    ...
    {
        var num = new BigNumber { whole = whole, numerator = numerator, denominator = denominator };
...
#pragma warning disable IDE0048 // 为清楚起见，请添加括号
        return FromBigInteger(aSign * BigInteger.Abs(a_numerator) + BigInteger.Abs(b_numerator) * bSign,
            new_denominator);
#pragma warning restore IDE0048 // 为清楚起见，请添加括号
    ...
    public static BigNumber Multiply(BigNumber a, BigNumber b)
    {
        a.ToAssociative();
        b.ToAssociative();
        var c = FromBigInteger(BigInteger.Abs(a.numerator * b.numerator),
            BigInteger.Abs(a.denominator * b.denominator));
