...
//                return "";
//            inputString = CommonHelper.HtmlToText(inputString);
...
//        {
//            const string ls_second_eng = "" +
...
//            const string ls_second_ch = "亍丌兀丐廿卅丕亘丞鬲孬噩丨禺丿匕乇夭爻卮氐囟胤馗毓睾鼗丶亟" +
