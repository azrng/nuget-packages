namespace CommonCollect.RetryTask
{
    ...
    public static class TaskExtensions
    {
        ...
        /// <exception cref="T:System.ArgumentNullException"></exception>
        /// <returns></returns>
        public static IRetryTask<TResult> Retry<TResult>(
            this ITask<TResult> task,
            int maxCount,
            TimeSpan delay)
        {
            return task.Retry(maxCount, (Func<int, TimeSpan>)(i => delay));
        }
        ...
        {
            return task.Handle().WhenCatch((Func<Exception, TResult>)(ex => default(TResult)));
        }
