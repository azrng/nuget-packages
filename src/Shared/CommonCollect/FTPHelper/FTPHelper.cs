...
namespace CommonCollect.FTPHelper
{
    /// <summary>
    /// FTP帮助类
    /// </summary>
    public class FTPHelper2
    {
        ...
        public FTPHelper2(string FtpServerIP, string FtpRemotePath, string FtpUserID, string FtpPassword)
        {
        ...
        public void Upload(string filename)
        {
            ...
            reqFTP = (FtpWebRequest)WebRequest.Create(new Uri(_ftpURI + fileInf.Name));
        ...
        public string[] GetFilesDetailList()
        {
            try
            {
                ...
                FtpWebRequest ftp;
                ftp = (FtpWebRequest)WebRequest.Create(new Uri(_ftpURI));
        ...
        public void MakeDir(string dirName)
        {
            ...
            reqFTP = (FtpWebRequest)WebRequest.Create(new Uri(_ftpURI + dirName));
        ...
        public void ReName(string currentFilename, string newFilename)
        {
            ...
            reqFTP = (FtpWebRequest)WebRequest.Create(new Uri(_ftpURI + currentFilename));
