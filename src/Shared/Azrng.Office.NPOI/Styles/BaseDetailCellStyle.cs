...
namespace Azrng.Office.NPOI.Styles
{
    ...
    /// 单元格样式
    /// </summary>
    public class BaseDetailCellStyle : BaseStyle
    {
        /// <summary>
        /// 单元格样式
        /// </summary>
        ...
        public BaseDetailCellStyle(bool isBold = false, bool wrapText = false, short fontColor = 8, short? fillForegroundColor = null,
                                   string fontName = "仿宋", int fontSize = 12, HorizontalAlignment horizontal = HorizontalAlignment.Center,
                                   VerticalAlignment vertical = VerticalAlignment.None, BorderStyle borderBottom = default,
