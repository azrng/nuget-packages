using JSqlParser.Net.Expression.Cnf;
...
public interface ExpressionVisitor<T>
{
    ...
    // Select-related
    T Visit<S>(JSqlParser.Net.Statement.Select.AllColumns allColumns, S context);
    T Visit<S>(JSqlParser.Net.Statement.Select.AllTableColumns allTableColumns, S context);
    T Visit<S>(JSqlParser.Net.Statement.Select.Select select, S context);
    ...
    void Visit(JSqlParser.Net.Statement.Select.AllColumns allColumns) => Visit<object?>(allColumns, default);
    void Visit(JSqlParser.Net.Statement.Select.AllTableColumns allTableColumns) => Visit<object?>(allTableColumns, default);
    void Visit(JSqlParser.Net.Statement.Select.Select select) => Visit<object?>(select, default);
