...
| T043 | Azrng.DuckDB.Quack benchmark 反馈优化 | 结合 dotnet-sample DuckDBQuackCompareBenchmarks 的 smoke/benchmark 与 LocalQuackDuckDB 用法，新增连接池租约 API、补池测试与文档；benchmark 覆盖建议已形成 | 阶段 1（实现完成，待确认） | REVIEW | 2026-06-21 |
