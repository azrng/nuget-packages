...
| T110 | Azrng.JSqlParser C# 风格化迁移（按 MIGRATION.md 第十五章批次表逐批改造，每批一提交） | 批 1-7、9a、10 完成；批 8 增量 1（Between/Parenthesis required）完成，其余 null! 字段按需推进；批 9b（Expression/Statement 接口加 I）暂缓，需 Roslyn 语义级重命名（正则无法区分 4 种身份）。全量 1436 项通过 | 阶段 1 | ZCode | REVIEW | P1 | 2026-07-18 |
