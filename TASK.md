...
| T065 | 缓存三包联动破坏性升级（ICacheProvider 启用 nullable：Core 1.0.0 / MemoryCache 3.0.0 / Redis 3.0.0；Redis 重命名 RedisConfig→RedisCacheOptions；RedisManage 连接管理全链路异步化） | DONE | 2026-07-03 |
