...
using CreateTable = JSqlParser.Net.Statement.CreateTable.CreateTable;
using Drop = JSqlParser.Net.Statement.Drop.Drop;
using Truncate = JSqlParser.Net.Statement.Truncate.Truncate;

namespace JSqlParser.Net.Test.Parser;
