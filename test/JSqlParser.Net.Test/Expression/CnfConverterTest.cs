...
namespace JSqlParser.Net.Test.Expression;
...
public class CnfConverterTest
{
    ...
    private static AndExpression And(JSqlParser.Net.Expression.Expression left, JSqlParser.Net.Expression.Expression right) => new()
    {
        LeftExpression = left,
        RightExpression = right
    };

    private static OrExpression Or(JSqlParser.Net.Expression.Expression left, JSqlParser.Net.Expression.Expression right) => new()
    {
        LeftExpression = left,
        RightExpression = right
    };
