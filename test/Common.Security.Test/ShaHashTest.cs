namespace Common.Security.Test
{
    public class ShaHashTest
    {
        ...
        public void Get_Sha1Hash_ReturnOk()
        {
            ...
            Assert.Equal(value, ShaHelper.GetSha1Hash(str), ignoreCase: true);
        }
        ...
        public void Get_Sha256Hash_ReturnOk()
        {
            ...
            Assert.Equal(value, ShaHelper.GetSha256Hash(str), ignoreCase: true);
        }
        ...
        public void Get_Sha512Hash_ReturnOk()
        {
            ...
            Assert.Equal(value, ShaHelper.GetSha512Hash(str), ignoreCase: true);
        }
