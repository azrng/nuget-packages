...
public class DeParserTest
{
    ...
    {
        var stmt = SqlParser.Parse("SELECT id, name FROM users")!;
    ...
    {
        var stmt = SqlParser.Parse("SELECT id FROM users UNION SELECT id FROM admins")!;
        var sql = stmt.ToString();
    ...
    {
        var stmt = SqlParser.Parse("SELECT id FROM users ORDER BY id DESC")!;
        var sql = stmt.ToString();
    ...
    {
        var stmt = SqlParser.Parse("SELECT name, COUNT(*) FROM users GROUP BY name")!;
        var sql = stmt.ToString();
