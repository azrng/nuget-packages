...
public class PivotTest
{
    ...
    {
        var stmt = CCJSqlParserUtil.Parse("SELECT * FROM t PIVOT (SUM(x) FOR c IN (1, 2)) AS p");
    ...
    {
        var stmt = CCJSqlParserUtil.Parse("SELECT * FROM t UNPIVOT INCLUDE NULLS (val FOR col IN (c1, c2))");
