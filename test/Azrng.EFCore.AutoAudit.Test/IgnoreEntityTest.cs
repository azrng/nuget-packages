...
public class IgnoreEntityTest
{
    [Fact]
    public void IgnoreEntity1()
    {
        ...
        {
            builder.IgnoreEntity<Test2Entity>()
    ...
    public void IgnoreEntity2()
    {
        ...
        services.AddEFCoreAutoAudit(builder =>
        {
            builder.IgnoreEntity(typeof(Test2Entity))
                .WithAuditRecordsDbContextStore(options => { options.UseSqlite("Data Source=d:\\db\\AutoAudit.db"); });
        }, DatabaseType.PostgresSql);
        using var serviceProvider = services.BuildServiceProvider();
